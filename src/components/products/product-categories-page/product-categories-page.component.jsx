...
import "./product-categories-page.component.scss";
import ProductCategoriesPageItem from "./product-categories-page-item.component";


class ProductCategoriesPageComponent extends React.Component {
  constructor() {
    super();
  ...
  render() {
    return (
      <div className="product-directory-menu">
        {this.state.productCategories.map(({ category , imageUrl, categoryId, linkUrl }) => (
          <ProductCategoriesPageItem key={categoryId} category={category} imageUrl={imageUrl} linkUrl={linkUrl} categoryId={categoryId} />
        ))}
      </div>
    );
  }
...
export default ProductCategoriesPageComponent;
