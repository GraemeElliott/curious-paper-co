...
import "./homepage-panels.component.scss";

const TextPanel = ({ title , subtitle, imageUrl, category, collectionId, colourScheme, backgroundColour }) => {
  return (
    <Link className={`panel-wrapper text-panel ${backgroundColour}`} to={`${category}/${collectionId}`}>
...
const ImagePanel = ({ title , subtitle, imageUrl, category, collectionId, colourScheme }) => {
    return (
