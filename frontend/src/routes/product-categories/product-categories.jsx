...
import ProductCategoriesPagePanel from "../../components/product-categories-page-panel/product-categories-page-panel.component";
    ...
    return (
      <div className="product-directory-menu">
        {this.state.productCategories.map(({ category , imageUrl, categoryId, linkUrl }) => (
          <ProductCategoriesPagePanel key={categoryId} category={category} imageUrl={imageUrl} linkUrl={linkUrl} categoryId={categoryId} />
        ))}
      </div>
    );
  }
