...
import './ProductsBySubcategory.scss';
...
function ProductsBySubcategory() {
  ...
  const urlSubcategory = useLocation().pathname.split('/')[3];
    ...
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get(
          `/products/${urlCategory}/${urlSubcategory}`
        );
  ...
  return (
    <div>
      ...
      <h1 className="product-subcategory-title">
        {urlSubcategory.replace(/-/g, ' ')}
      </h1>
